...
function buildPrompt(ctx: CoverLetterContext, candidate: ReturnType<typeof parseCandidateInfo>): string {
  ...
  lines.push(
    ...
    `Write 3–4 paragraphs, 180–300 words total, plain text only (no markdown, no headers, no bullet points).`,
    `Para 1: Name the role and state one specific hook connecting your background to this position.`,
    `Para 2: Reference 2–4 of your specific projects or work experiences that directly match the JD requirements.`,
